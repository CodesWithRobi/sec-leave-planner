...
export const MENTOR: SlotDetail = {
  slot: {
    id: 1993,
    slotName: '26OD1M107',
...
export const HOLIDAYS = new Set(['2026-08-26', '2026-09-04', '2026-09-14'])
export const ALL_SLOTS = [JAVA, MA212, HRM, AOA, MENTOR, SDCP1, SDCP2]